        ...
        try {
            ...
            if (response.data.success) {
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="text-left">
                            <h3 class="text-lg font-semibold mb-4">Registration Summary:</h3>
                            
                            <div class="space-y-3">
                                <p><span class="font-medium">Child Name:</span> ${data.childName}</p>
                                <p><span class="font-medium">Class:</span> ${data.class}</p>
                                <p><span class="font-medium">Date of Birth:</span> ${data.dateOfBirth}</p>
                                <p><span class="font-medium">Address:</span> ${data.address}, ${data.city}, ${data.state}, ${data.country}, ${data.zipCode}</p>
                                
                                <div class="mt-4">
                                    <p class="font-medium mb-2">Pickup Persons:</p>
                                    ${data.pickupPersons.map(person => 
                                        `<p>${person.name} (${person.relation}) - ${person.contactNumber}</p>`
                                    ).join('')}
                                </div>
                            </div>
                        </div>
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center">
                    ...
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Add Student</h2>
                </div>
            }
        >
                                            ...
                                            <div className="grid grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        className="mt-1 block w-full"
                                                        onChange={(e) => handlePickupPersonChange(index, 'contactNumber', e.target.value)}
                                                        pattern="[0-9]{10}"
                                                        maxLength="10"
